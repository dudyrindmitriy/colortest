...
class ChartController extends Controller
{
    ...
    /**
     * Получение данных для пузырьковой диаграммы (цвета и их ассоциации)
     */
    ...
    /**
     * Получение данных для календарной диаграммы (активность по дням)
     */
    ...
    /**
     * Получение данных для организационной диаграммы (структура ассоциаций)
     */
    public function orgDistribution()
{
    ...
    /**
     * Получение данных для диаграммы Санки (цвета -> профессии)
     */
    public function sankeyDistribution()
{
    ...
    /**
     * Получение данных для хронологии
     */
