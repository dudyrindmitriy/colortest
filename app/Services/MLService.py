...
class MLService:
    ...
    def evaluate_models(test_size=0.2, random_state=42):
        ...
        logger = logging.getLogger('MLService.evaluate_models')
    ...
    n_estimators=10)
                ...
                # Логирование
                logger.info(f"{target} - Test accuracy: {accuracy_score(y_test_encoded, y_pred):.4f}")
    ...
    def train_model():
        ...
        logger = logging.getLogger('MLService.train_model')
    ...
    def predict(features, model_dir='models'):
        ...
        logger = logging.getLogger('MLService.predict')
